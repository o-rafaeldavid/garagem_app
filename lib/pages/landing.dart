...
class _LandingScreenState extends State<LandingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    <Widget>[
      RoundRectColumned(
        width: widthGapped, height: widthGapped * 0.25,
    ...
    <Widget>[
      RoundRectColumned(
        width: 3 * quarter_widthGapped, height: widthGapped * 0.25,
      ...
      RoundRectColumned(
        ...
        width: quarter_widthGapped, height: widthGapped * 0.25,
        mainAxisAlignment: MainAxisAlignment.center,
        crossAxisAlignment: CrossAxisAlignment.center,
    ...
    <Widget>[
      RoundRectColumned(
        ...
        width: half_widthGapped, height: half_widthGapped,
        children: <Widget>[
    ...
    return Scaffold(
      ...
      body: StreamBuilder<String>(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return Container(
              margin: const EdgeInsets.fromLTRB(GlobalVars.gap, 0, GlobalVars.gap, 0),
              child: Stack(
                children: <Widget>[
