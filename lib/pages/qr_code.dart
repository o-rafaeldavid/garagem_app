...
class _QRCodeWidgetState extends State<QRCodeWidget> with RouteAware {
  ...
  void _successResGaragem(String payload) {
    ...
    if (_qrInicializado) {
      _garageStatusDB
          .create(title: lowerFinal[0].toUpperCase() + lowerFinal.substring(1))
                  ...
                  if (_cameraPermissionGranted) ...<Widget>[
                    Container(
                        padding: const EdgeInsets.only(
                            bottom: GlobalVars.appbarHeight + GlobalVars.gap),
                        child: Column(children: <Widget>[
                          Container(
                            margin:
                                const EdgeInsets.only(bottom: GlobalVars.gap),
                            child: Text("SCAN YOUR GARAGE HERE",
                                style: GoogleFonts.orbitron(
                                    textStyle: TxtStyles.heading2(null, 0))),
                          ),
                          GestureDetector(
